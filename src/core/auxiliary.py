...
def get_sorted_section_or_aggregation_values(data: dict[str, Any], type_: str, key: str, reverse: bool = False) -> list[tuple[str, int]]:
    ...
    return sorted(section_times.items(), key=lambda kv: kv[1], reverse=reverse)